...
import argparse
import time
from Utils.utils import choose_run_mode, load_pretrain_model, set_video_writer
...
while cv.waitKey(1) < 0:
    ...
    if has_frame:
        ...
        cv.namedWindow('Action Recognition based on OpenPose', 0)
        cv.resizeWindow('Action Recognition based on OpenPose', 900, 900)
